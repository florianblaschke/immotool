...
const cards: {
  ...
  },
  {
    ...
    data: "€15,201.55",
    compared: "+5.1% from last month",
    icon: <Euro className="h-4 w-4 text-muted-foreground" />,
  },
  {
    name: "Mieter gesamt",
    data: "29",
    compared: "+0.0% from last month",
    icon: <Users className="h-4 w-4 text-muted-foreground" />,
  },
  {
    name: "Leere Wohnungen",
    data: "2",
    compared: "+15.0% from last month",
        ...
        <div className="grid gap-4 md:grid-cols-2 md:gap-8 lg:grid-cols-4">
          {cards.map((entry) => (
            <Card key={entry.name}>
              ...
              <CardContent>
                <div className="text-2xl font-bold">{entry.data}</div>
